...
namespace TestTable
{
    ...
    { 
        ...
        public delegate void OnLoadedFromGoogleSheets(List<User> loadedList, Dictionary<int, User> loadedDictionary);

        static bool isLoaded = false;
        static string spreadSheetID = "1FBQUT4sB8_r5znhX2f82Q4XH0BCNEWlVqKqHWweN7a8"; // it is file id
        static string sheetID = "1622118055"; // it is sheet id
...
/* Your Loaded Data Storage. */
        ...
        /// - Auto Load
        /// </summary>
        public static Dictionary<int, User>  GetDictionary()
        {{
           if (isLoaded == false) Load();
           return UserMap;
        }}
...
/* Fields. */
		...
		public System.String intValue;
		public System.String pw;
		public System.Int32 strValue;
...
#region fuctions
        ...
        public static void LoadFromGoogle(System.Action<List<User>, Dictionary<int, User>> onLoaded, bool updateCurrentData = false)
        {      
    ...
    public static (List<User> list, Dictionary<int, User> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
